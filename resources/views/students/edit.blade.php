...
@endif
<div class="col-md-12">
<form action="{{ route('student.update',$data['id']) }}" method="POST" enctype="multipart/form-data" role="form" style="width: 60%; margin: 0 auto; background-color: white;">
    @csrf
    <div class="card-body">
      ...
      <div class="form-group">
        ...
        <img src="{{ asset('uploads/'.$data['image']) }}" style="width: 150px; height: 150px;">
