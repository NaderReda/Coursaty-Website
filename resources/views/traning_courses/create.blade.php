...
@endif
<div class="col-md-12">
<form action="{{ route('traning_course.store') }}" method="POST" role="form" style="width: 60%; margin: 0 auto; background-color: white;">
    @csrf
    <div class="card-body">
      ...
      <button type="submit" class="btn btn-primary">أضف الدورة التدريبية</button>
      </div>
